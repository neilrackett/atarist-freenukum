...
void fn_level_actor_function_conveyor_act(FnLevelActorActParams p);

void fn_level_actor_function_conveyor_blit(FnLevelActorBlitParams p);

void fn_level_actor_function_conveyor_create(FnLevelActorCreateParams p);
...
void fn_level_actor_function_hostileshot_act(FnLevelActorActParams p);

void fn_level_actor_function_hostileshot_blit(FnLevelActorBlitParams p);

void fn_level_actor_function_hostileshot_create(FnLevelActorCreateParams p);

void fn_level_actor_function_hostileshot_free(FnLevelActorFreeParams p);

void fn_level_actor_function_hostileshot_hero_touch_end(FnLevelActorHeroTouchEndParams p);

void fn_level_actor_function_hostileshot_hero_touch_start(FnLevelActorHeroTouchStartParams p);
...
void fn_level_actor_function_keyhole_create(FnLevelActorCreateParams p);

void fn_level_actor_function_keyhole_free(FnLevelActorFreeParams p);

void fn_level_actor_function_keyhole_hero_interact_start(FnLevelActorHeroInteractStartParams p);
...
void fn_level_actor_hero_interact_start(FnLevelActor *actor,
                                        FnLevelData *level_data,
                                        FnHeroData *hero_data,
                                        FnInfoMessageQueue *info_message_queue,
                                        FnLevelActorMessageQueue *actor_message_queue);

bool fn_level_actor_hurts_hero(const FnLevelActor *actor);

bool fn_level_actor_in_foreground(const FnLevelActor *actor);

bool fn_level_actor_is_alive(const FnLevelActor *actor);

bool fn_level_actor_is_visible(const FnLevelActor *actor);
...
bool fn_level_actor_touches_hero(const FnLevelActor *actor,
                                 const FnHeroData *hero_data);
